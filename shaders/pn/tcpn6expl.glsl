...
void main()
{
    ...
    int p1 = wrapper(gl_InvocationID + 1, 6);
    ...
    cps[gl_InvocationID].b[1] = 2.0 * position[gl_InvocationID] + project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p4]);
    cps[gl_InvocationID].b[2] = 2.0 * position[gl_InvocationID] + project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p3]);
    cps[gl_InvocationID].b[3] = 2.0 * position[gl_InvocationID] + project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p2]);
    cps[gl_InvocationID].b[4] = 2.0 * position[gl_InvocationID] + project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p1]);
    ...
    if(gl_InvocationID == 0 || gl_InvocationID == 1) {
        mid = (position[gl_InvocationID] + position[p2] + position[p4]);
        mids[gl_InvocationID] = (mid + 3.0*project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], mid/3.0)
                                 + 3.0*project(normalize(normal[p2]), position[p2], mid/3.0)
                                 + 3.0*project(normalize(normal[p4]), position[p4], mid/3.0))/12.0;
    }
