...
vec3 evaluatePatchCub() {
        ...
        return sqd[0] * weights[0] * tc_position[0] +
               ...
               sqd[5] * weights[5] * tc_position[5] +
                 ...
                 sqd[0] * weights[5] * cps[0].b[0] +
                 sqd[0] * weights[4] * cps[0].b[1] +
                 sqd[0] * weights[3] * cps[0].b[2] +
                 sqd[0] * weights[2] * cps[0].b[3] +
                 sqd[0] * weights[1] * cps[0].b[4] +

                 sqd[1] * weights[0] * cps[1].b[0] +
                 sqd[1] * weights[5] * cps[1].b[1] +
                 sqd[1] * weights[4] * cps[1].b[2] +
                 sqd[1] * weights[3] * cps[1].b[3] +
                 sqd[1] * weights[2] * cps[1].b[4] +

                 sqd[2] * weights[1] * cps[2].b[0] +
                 sqd[2] * weights[0] * cps[2].b[1] +
                 sqd[2] * weights[5] * cps[2].b[2] +
                 sqd[2] * weights[4] * cps[2].b[3] +
                 sqd[2] * weights[3] * cps[2].b[4] +

                 sqd[3] * weights[2] * cps[3].b[0] +
                 sqd[3] * weights[1] * cps[3].b[1] +
                 sqd[3] * weights[0] * cps[3].b[2] +
                 sqd[3] * weights[5] * cps[3].b[3] +
                 sqd[3] * weights[4] * cps[3].b[4] +

                 sqd[4] * weights[3] * cps[4].b[0] +
                 sqd[4] * weights[2] * cps[4].b[1] +
                 sqd[4] * weights[1] * cps[4].b[2] +
                 sqd[4] * weights[0] * cps[4].b[3] +
                 sqd[4] * weights[5] * cps[4].b[4] +
                ...
                6.0 *( weights[5] * weights[0] * weights[1] * cps[0].m[0] +
                 ...
                 weights[4] * weights[5] * weights[0] * cps[5].m[0] +

                 weights[0] * weights[2] * weights[5] * cps[0].m[1] +
                 weights[1] * weights[3] * weights[0] * cps[1].m[1] +
                 weights[2] * weights[4] * weights[1] * cps[2].m[1] +
                 weights[3] * weights[5] * weights[2] * cps[3].m[1] +
                 weights[4] * weights[0] * weights[3] * cps[4].m[1] +
                 weights[5] * weights[1] * weights[4] * cps[5].m[1] +

                 weights[0] * weights[3] * weights[5] * cps[0].m[2] +
                 weights[1] * weights[4] * weights[0] * cps[1].m[2] +
                 weights[2] * weights[5] * weights[1] * cps[2].m[2] +
                 weights[3] * weights[0] * weights[2] * cps[3].m[2] +
                 weights[4] * weights[1] * weights[3] * cps[4].m[2] +
                 weights[5] * weights[2] * weights[4] * cps[5].m[2] +

                 weights[0] * weights[2] * weights[4] * mids[0] +
                 weights[1] * weights[3] * weights[5] * mids[1]);
}
...
vec3 pnNormal() {
        return weights[0] * weights[0]  * normalize(tc_normal[0]) +
               ...
               2.0 * (
                ...
                weights[0] * weights[5] * normalize(norms[0].n[0] + norms[5].n[4]) +
                weights[0] * weights[4] * normalize(norms[0].n[1] + norms[4].n[3]) +
                weights[0] * weights[3] * normalize(norms[0].n[2] + norms[3].n[2]) +
                weights[0] * weights[2] * normalize(norms[0].n[3] + norms[2].n[1]) +
                weights[0] * weights[1] * normalize(norms[0].n[4] + norms[1].n[0]) +

                weights[1] * weights[5] * normalize(norms[1].n[1] + norms[5].n[3]) +
                weights[1] * weights[4] * normalize(norms[1].n[2] + norms[4].n[2]) +
                weights[1] * weights[3] * normalize(norms[1].n[3] + norms[3].n[1]) +
                weights[1] * weights[2] * normalize(norms[1].n[4] + norms[2].n[0]) +

                weights[2] * weights[5] * normalize(norms[2].n[2] + norms[5].n[2]) +
                weights[2] * weights[4] * normalize(norms[2].n[3] + norms[4].n[1]) +
                weights[2] * weights[3] * normalize(norms[2].n[4] + norms[3].n[0]) +

                weights[3] * weights[5] * normalize(norms[3].n[3] + norms[5].n[1]) +
                weights[3] * weights[4] * normalize(norms[3].n[4] + norms[4].n[0]) +

                weights[4] * weights[5] * normalize(norms[4].n[4] + norms[5].n[0])
