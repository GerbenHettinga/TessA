...
vec3 evaluatePatchCub() {
        ...
        return sqd[0] * weights[0] * tc_position[0] +
               ...
               sqd[6] * weights[6] * tc_position[6] +
                 ...
                 sqd[0] * weights[6] * cps[0].b[0] +
                 sqd[0] * weights[5] * cps[0].b[1] +
                 sqd[0] * weights[4] * cps[0].b[2] +
                 sqd[0] * weights[3] * cps[0].b[3] +
                 sqd[0] * weights[2] * cps[0].b[4] +
                 sqd[0] * weights[1] * cps[0].b[5] +

                 sqd[1] * weights[0] * cps[1].b[0] +
                 sqd[1] * weights[6] * cps[1].b[1] +
                 sqd[1] * weights[5] * cps[1].b[2] +
                 sqd[1] * weights[4] * cps[1].b[3] +
                 sqd[1] * weights[3] * cps[1].b[4] +
                 sqd[1] * weights[2] * cps[1].b[5] +

                 sqd[2] * weights[1] * cps[2].b[0] +
                 sqd[2] * weights[0] * cps[2].b[1] +
                 sqd[2] * weights[6] * cps[2].b[2] +
                 sqd[2] * weights[5] * cps[2].b[3] +
                 sqd[2] * weights[4] * cps[2].b[4] +
                 sqd[2] * weights[3] * cps[2].b[5] +

                 sqd[3] * weights[2] * cps[3].b[0] +
                 sqd[3] * weights[1] * cps[3].b[1] +
                 sqd[3] * weights[0] * cps[3].b[2] +
                 sqd[3] * weights[6] * cps[3].b[3] +
                 sqd[3] * weights[5] * cps[3].b[4] +
                 sqd[3] * weights[4] * cps[3].b[5] +

                 sqd[4] * weights[3] * cps[4].b[0] +
                 sqd[4] * weights[2] * cps[4].b[1] +
                 sqd[4] * weights[1] * cps[4].b[2] +
                 sqd[4] * weights[0] * cps[4].b[3] +
                 sqd[4] * weights[6] * cps[4].b[4] +
                 sqd[4] * weights[5] * cps[4].b[5] +
                ...
                6.0 * (
                    ...
                    weights[6] * weights[0] * weights[1] * cps[0].m[0] +
                    weights[6] * weights[0] * weights[2] * cps[0].m[1] +
                    weights[6] * weights[0] * weights[3] * cps[0].m[2] +
                    weights[6] * weights[0] * weights[4] * cps[0].m[3] +
                    ...
                    weights[2] * weights[3] * weights[0] * cps[3].m[3] +

                    weights[3] * weights[4] * weights[5] * cps[4].m[0] +
                    weights[3] * weights[4] * weights[6] * cps[4].m[1] +
                    weights[3] * weights[4] * weights[0] * cps[4].m[2] +
                    weights[3] * weights[4] * weights[1] * cps[4].m[3] +

                    weights[4] * weights[5] * weights[6] * cps[5].m[0] +
                    weights[4] * weights[5] * weights[0] * cps[5].m[1] +
                    weights[4] * weights[5] * weights[1] * cps[5].m[2] +
                    weights[4] * weights[5] * weights[2] * cps[5].m[3] +

                    weights[5] * weights[6] * weights[0] * cps[6].m[0] +
                    weights[5] * weights[6] * weights[1] * cps[6].m[1] +
                    weights[5] * weights[6] * weights[2] * cps[6].m[2] +
                    weights[5] * weights[6] * weights[3] * cps[6].m[3] +

                    weights[0] * weights[5] * weights[2] * cps[0].m[4] +
                    weights[1] * weights[6] * weights[3] * cps[1].m[4] +
                    weights[2] * weights[0] * weights[4] * cps[2].m[4] +
                    weights[3] * weights[1] * weights[5] * cps[3].m[4] +
                    weights[4] * weights[2] * weights[6] * cps[4].m[4] +
                    weights[5] * weights[3] * weights[0] * cps[5].m[4] +
                    weights[6] * weights[4] * weights[1] * cps[6].m[4]
