...
vec3 evaluatePatchCub() {
    ...
    for(int i = 0; i < N; i++) {
        ...
        return sqd[0] * weights[0] * tc_position[0] +
               ...
               sqd[0] * weights[3] * cps[0].b[0] +
               sqd[0] * weights[2] * cps[0].b[1] +
               sqd[0] * weights[1] * cps[0].b[2] +

               sqd[1] * weights[0] * cps[1].b[0] +
               sqd[1] * weights[3] * cps[1].b[1] +
               sqd[1] * weights[2] * cps[1].b[2] +

               sqd[2] * weights[1] * cps[2].b[0] +
               sqd[2] * weights[0] * cps[2].b[1] +
               sqd[2] * weights[3] * cps[2].b[2] +
            ...
            +
               6.0 * (
                    weights[0] * weights[1] * weights[2] * cps[1].m +
                    weights[1] * weights[2] * weights[3] * cps[2].m +
                    weights[0] * weights[2] * weights[3] * cps[3].m +
                    weights[0] * weights[1] * weights[3] * cps[0].m
                );
}
