...
void main()
{
    ...
    position = (ps[gl_PrimitiveIDIn] + 3.0*T1)/4.0;
    normal = vec3(1.0, 0.0, 0.0);
    gl_Position = matrix * vec4(position, 1.0);
    EmitVertex();

    vec3 p1T0 = p * project(ns[p1], ps[p1], ps[gl_PrimitiveIDIn]) + (1.0 - p) * ps[p1];
    position = (T1 + p1T0)/2.0;
    normal = vec3(1.0, 0.0, 0.0);
    gl_Position = matrix * vec4(position, 1.0);
    EmitVertex();

    position = (ps[p1] + 3.0*p1T0)/4.0;
    normal = vec3(1.0, 0.0, 0.0);
    gl_Position = matrix * vec4(position, 1.0);
    EmitVertex();
    ...
    normal = vec3(1.0, 0.0, 0.0);
    gl_Position = matrix * vec4((T1 + p1T0)/2.0, 1.0);
    EmitVertex();
    ...
    normal = vec3(0.0, 0.0, 1.0);
    gl_Position = matrix * vec4(p1I2, 1.0);
    EmitVertex();
    ...
    normal = vec3(1.0, 0.0, 0.0);
    gl_Position = matrix * vec4(p1I1, 1.0);
    EmitVertex();
