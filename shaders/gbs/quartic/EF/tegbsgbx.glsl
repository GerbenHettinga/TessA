...
float D_3(float u) {
    ...
    if(u < 1.0) {
        ...
        float v = u - 2.0;
        B_3 = (-4.0*v*v*v*v + 12.0*v*v*v - 6.0*v*v - 12.0*v + 11.0) / 24.0;
    } else {
        float v = u - 3.0;
        B_3 = (1.0 - v)*(1.0 - v)*(1.0 - v)*(1.0 - v) / 24.0;
    }
    return B_3;
}
...
vec3 tensorCubic() {
    ...
    for(int i = 0; i < N; i++) {
        ...
        if(si[i] <= 0.25) {
            ...
            muvu *      B3 * (D0 * J[m1].b[3]  + D1 * J[m1].b[7] + D2 * J[m1].b[11] + D3 * J[m1].b[15]) +
            muv1u *     B4 * (D0 * J[i].b[12]  + D1 * J[i].b[13] + D2 * J[i].b[14]  + D3 * J[i].b[15]);
            ...
            muvu *      B2 * (D0 * J[m1].b[3]  + D1 * J[m1].b[7] + D2 * J[m1].b[11] + D3 * J[m1].b[15]) +
            muv1u *     B3 * (D0 * J[i].b[12]  + D1 * J[i].b[13] + D2 * J[i].b[14]  + D3 * J[i].b[15]) +
            ...
            muvu *      B1 * (D0 * J[m1].b[3]  + D1 * J[m1].b[7] + D2 * J[m1].b[11] + D3 * J[m1].b[15]) +
            muv1u *     B2 * (D0 * J[i].b[12]  + D1 * J[i].b[13] + D2 * J[i].b[14]  + D3 * J[i].b[15]) +
            ...
            sidesum =
            muvu *      B0 * (D0 * J[m1].b[3]  + D1 * J[m1].b[7] + D2 * J[m1].b[11]  + D3 * J[m1].b[15]) +
            muv1u *     B1 * (D0 * J[i].b[12]  + D1 * J[i].b[13] + D2 * J[i].b[14]   + D3 * J[i].b[15]) +
...
vec3 cubicBoundary() {
    ...
    if(weights[side] > 0.75) {
        ...
        pos = B00 * (J[side].b[0] + 11.0*J[side].b[4] + 11.0*J[side].b[8]  + J[side].b[12])/24.0 +
              ...
              B40 * (J[p1].b[12]  + 11.0*J[p1].b[13]  + 11.0*J[p1].b[14]   + J[p1].b[15])/24.0  ;

    } else if(weights[side] > 0.5) {
        t = 1.0 - t;
        t = t * 4.0 - 1.0;
        ...
        pos = B00 * (J[side].b[1] + 11.0*J[side].b[5] + 11.0*J[side].b[9]  + J[side].b[13]) / 24.0 +
              ...
              B30 * (J[p1].b[12]  + 11.0*J[p1].b[13]  + 11.0*J[p1].b[14]  + J[p1].b[15]) / 24.0 +
              B40 * (J[p1].b[8]   + 11.0*J[p1].b[9]   + 11.0*J[p1].b[10]  + J[p1].b[11]) / 24.0;

    } else if(weights[side] > 0.25) {
        t = 1.0 - t;
        t = t * 4.0 - 2.0;
        ...
        pos = B00 * (J[side].b[2] + 11.0*J[side].b[6] + 11.0*J[side].b[10] + J[side].b[14]) / 24.0 +
              ...
              B20 * (J[p1].b[12]  + 11.0*J[p1].b[13]  + 11.0*J[p1].b[14]   + J[p1].b[15]) / 24.0 +
        ...
        pos = B00 * (J[side].b[3] + 11.0*J[side].b[7] + 11.0*J[side].b[11] + J[side].b[15]) / 24.0 +
              B10 * (J[p1].b[12]  + 11.0*J[p1].b[13]  + 11.0*J[p1].b[14]   + J[p1].b[15]) / 24.0 +
