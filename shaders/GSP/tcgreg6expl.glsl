...
void main()
{
    ...
    int m1 = wrapper(gl_InvocationID - 1, 6);
    int p5 = (gl_InvocationID + 5) % 6;
    int p4 = (gl_InvocationID + 4) % 6;
    int p3 = (gl_InvocationID + 3) % 6;
    int p2 = (gl_InvocationID + 2) % 6;
    int p1 = (gl_InvocationID + 1) % 6;
    ...
    vec3 H1 = cps[p1].b[4] - cps[gl_InvocationID].b[0];
    vec3 H2 = position[p1] - cps[p1].b[4];
    ...
    vec3 C1 = mix(C0, C3, 2.0/3.0);
    vec3 C2 = mix(C3, C0, 2.0/3.0);
    ...
    cps[gl_InvocationID].f[1] = cps[p1].b[4] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[3] = cps[p1].b[4] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[5] = cps[p1].b[4] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[7] = cps[p1].b[4] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;

    if(quadNormals) {
        int p4 = wrapper(gl_InvocationID + 4, 6);
        int p3 = wrapper(gl_InvocationID + 3, 6);
        int p2 = wrapper(gl_InvocationID + 2, 6);

        norms[gl_InvocationID].n[0] = reflect(gl_InvocationID, m1);
        norms[gl_InvocationID].n[1] = reflect(gl_InvocationID, p4);
        norms[gl_InvocationID].n[2] = reflect(gl_InvocationID, p3);
        norms[gl_InvocationID].n[3] = reflect(gl_InvocationID, p2);
        norms[gl_InvocationID].n[4] = reflect(gl_InvocationID, p1);
    }
