...
void main()
{
    ...
    int p7 = (gl_InvocationID + 7) % 8;
    int p6 = (gl_InvocationID + 6) % 8;
    int p5 = (gl_InvocationID + 5) % 8;
    int p4 = (gl_InvocationID + 4) % 8;
    int p3 = (gl_InvocationID + 3) % 8;
    int p2 = (gl_InvocationID + 2) % 8;
    int p1 = (gl_InvocationID + 1) % 8;
    ...
    cps[gl_InvocationID].b[4] = mix(position[gl_InvocationID], project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p5]), p);
    cps[gl_InvocationID].b[5] = mix(position[gl_InvocationID], project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p6]), p);
    cps[gl_InvocationID].b[6] = mix(position[gl_InvocationID], project(normalize(normal[gl_InvocationID]), position[gl_InvocationID], position[p7]), p);

    barrier();

    vec3 H0 = cps[gl_InvocationID].b[0] - position[gl_InvocationID];
    vec3 H0Hat = normalize(H0);
    vec3 H1 = cps[p1].b[6] - cps[gl_InvocationID].b[0];
    vec3 H2 = position[p1] - cps[p1].b[6];
    ...
    F0 = (0.75*cps[gl_InvocationID].b[6] + 0.25*position[gl_InvocationID]) - position[gl_InvocationID];
    F3 = (0.75*cps[p1].b[5] + 0.25*position[p1]) - position[p1];
    ...
    cps[gl_InvocationID].f[1] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;



    F0 = (0.75*cps[gl_InvocationID].b[5] + 0.25*position[gl_InvocationID]) - position[gl_InvocationID];
    F3 = (0.75*cps[p1].b[4] + 0.25*position[p1]) - position[p1];
    ...
    cps[gl_InvocationID].f[3] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;



    F0 = (0.75*cps[gl_InvocationID].b[4] + 0.25*position[gl_InvocationID]) - position[gl_InvocationID];
    F3 = (0.75*cps[p1].b[3] + 0.25*position[p1]) - position[p1];

    ratios = findRatios(F0, F3, length(H0), H0Hat, length(H2), H2Hat, C0, C3);
    k0 = ratios[0]; h0 = ratios[1];  k1 = ratios[2];  h1 = ratios[3];

    cps[gl_InvocationID].f[4] = cps[gl_InvocationID].b[0] + (k1-k0)*C0/3.0 + 2.0*h0*H1/3.0 + h1*H0/3.0 + k0*C1;
    cps[gl_InvocationID].f[5] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[6] = cps[gl_InvocationID].b[0] + (k1-k0)*C0/3.0 + 2.0*h0*H1/3.0 + h1*H0/3.0 + k0*C1;
    cps[gl_InvocationID].f[7] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[8] = cps[gl_InvocationID].b[0] + (k1-k0)*C0/3.0 + 2.0*h0*H1/3.0 + h1*H0/3.0 + k0*C1;
    cps[gl_InvocationID].f[9] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[10] = cps[gl_InvocationID].b[0] + (k1-k0)*C0/3.0 + 2.0*h0*H1/3.0 + h1*H0/3.0 + k0*C1;
    cps[gl_InvocationID].f[11] = cps[p1].b[6] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    if(quadNormals) {
        ...
        norms[gl_InvocationID].n[1] = reflect(gl_InvocationID, p6);
        norms[gl_InvocationID].n[2] = reflect(gl_InvocationID, p5);
        norms[gl_InvocationID].n[3] = reflect(gl_InvocationID, p4);
        norms[gl_InvocationID].n[4] = reflect(gl_InvocationID, p3);
        norms[gl_InvocationID].n[5] = reflect(gl_InvocationID, p2);
        norms[gl_InvocationID].n[6] = reflect(gl_InvocationID, p1);
    }
}
