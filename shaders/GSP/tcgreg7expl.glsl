...
void main()
{
    ...
    int p6 = (gl_InvocationID + 6) % 7;
    int p5 = (gl_InvocationID + 5) % 7;
    int p4 = (gl_InvocationID + 4) % 7;
    int p3 = (gl_InvocationID + 3) % 7;
    int p2 = (gl_InvocationID + 2) % 7;
    int p1 = (gl_InvocationID + 1) % 7;
    ...
    vec3 H1 = cps[p1].b[5] - cps[gl_InvocationID].b[0];
    vec3 H2 = position[p1] - cps[p1].b[5];
    ...
    cps[gl_InvocationID].f[1] = cps[p1].b[5] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[3] = cps[p1].b[5] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[5] = cps[p1].b[5] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[7] = cps[p1].b[5] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    cps[gl_InvocationID].f[9] = cps[p1].b[5] + k1*C2 - (k1-k0)*C3/3.0 + h0*H2/3.0 + 2.0*h1*H1/3.0;
    ...
    if(quadNormals) {
        ...
        norms[gl_InvocationID].n[0] = reflect(gl_InvocationID, p1);
    }
}
