...
vec3 evaluatePatchQuad() {
        return weights[0] * weights[0] * tc_position[0] +
               ...
               weights[0] * weights[3] * (cps[0].b[0] + cps[3].b[2]) +
               weights[0] * weights[2] * (cps[0].b[1] + cps[2].b[1]) +
               weights[0] * weights[1] * (cps[0].b[2] + cps[1].b[0]) +
               weights[1] * weights[3] * (cps[1].b[1] + cps[3].b[1]) +
               weights[1] * weights[2] * (cps[1].b[2] + cps[2].b[0]) +
               weights[2] * weights[3] * (cps[2].b[2] + cps[3].b[0]);
}
