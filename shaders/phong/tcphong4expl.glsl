...
void main()
{
    ...
    cps[gl_InvocationID].b[1] = project(normalize(normal[p2]), position[p2], position[gl_InvocationID]);
    cps[gl_InvocationID].b[2] = project(normalize(normal[p1]), position[p1], position[gl_InvocationID]);
