...
void main()
{
    ...
    cps[gl_InvocationID].b[1] = project(normalize(normal[p4]), position[p4], position[gl_InvocationID]);

    cps[gl_InvocationID].b[2] = project(normalize(normal[p3]), position[p3], position[gl_InvocationID]);

    cps[gl_InvocationID].b[3] = project(normalize(normal[p2]), position[p2], position[gl_InvocationID]);

    cps[gl_InvocationID].b[4] = project(normalize(normal[p1]), position[p1], position[gl_InvocationID]);
