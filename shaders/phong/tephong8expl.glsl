...
vec3 evaluatePatchQuad() {
    return weights[0] * weights[0]  * tc_position[0] +
           ...
           weights[5] * weights[5]  * tc_position[5] +
           weights[6] * weights[6]  * tc_position[6] +
           weights[7] * weights[7]  * tc_position[7] +

           weights[0] * weights[7] * (cps[0].b[0] + cps[7].b[6]) +
           weights[0] * weights[6] * (cps[0].b[1] + cps[6].b[5]) +
           weights[0] * weights[5] * (cps[0].b[2] + cps[5].b[4]) +
           weights[0] * weights[4] * (cps[0].b[3] + cps[4].b[3]) +
           weights[0] * weights[3] * (cps[0].b[4] + cps[3].b[2]) +
           weights[0] * weights[2] * (cps[0].b[5] + cps[2].b[1]) +
           weights[0] * weights[1] * (cps[0].b[6] + cps[1].b[0]) +

           weights[1] * weights[7] * (cps[1].b[1] + cps[7].b[5]) +
           weights[1] * weights[6] * (cps[1].b[2] + cps[6].b[4]) +
           weights[1] * weights[5] * (cps[1].b[3] + cps[5].b[3]) +
           weights[1] * weights[4] * (cps[1].b[4] + cps[4].b[2]) +
           weights[1] * weights[3] * (cps[1].b[5] + cps[3].b[1]) +
           weights[1] * weights[2] * (cps[1].b[6] + cps[2].b[0]) +

           weights[2] * weights[7] * (cps[2].b[2] + cps[7].b[4]) +
           weights[2] * weights[6] * (cps[2].b[3] + cps[6].b[3]) +
           weights[2] * weights[5] * (cps[2].b[4] + cps[5].b[2]) +
           weights[2] * weights[4] * (cps[2].b[5] + cps[4].b[1]) +
           weights[2] * weights[3] * (cps[2].b[6] + cps[3].b[0]) +

           weights[3] * weights[7] * (cps[3].b[3] + cps[7].b[3]) +
           weights[3] * weights[6] * (cps[3].b[4] + cps[6].b[2]) +
           weights[3] * weights[5] * (cps[3].b[5] + cps[5].b[1]) +
           weights[3] * weights[4] * (cps[3].b[6] + cps[4].b[0]) +

           weights[4] * weights[7] * (cps[4].b[4] + cps[7].b[2]) +
           weights[4] * weights[6] * (cps[4].b[5] + cps[6].b[1]) +
           weights[4] * weights[5] * (cps[4].b[6] + cps[5].b[0]) +

           weights[5] * weights[7] * (cps[5].b[5] + cps[7].b[1]) +
           weights[5] * weights[6] * (cps[5].b[6] + cps[6].b[0]) +

           weights[6] * weights[7] * (cps[6].b[6] + cps[7].b[0]);
}
