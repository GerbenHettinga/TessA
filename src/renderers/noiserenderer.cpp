...
NoiseRenderer::NoiseRenderer(RenderParameters* rp)
    : SurfaceRenderer(rp)
{
    initBuffers();
    initShaders();
...
void NoiseRenderer::initBuffers() {
...
void NoiseRenderer::initShaders() {
...
void NoiseRenderer::updateBuffers(Model& model) {
...
void NoiseRenderer::render(Model& model) {
    glBindVertexArray(vao);
